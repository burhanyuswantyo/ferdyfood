...
<head>
  ...
  <script src="https://kit.fontawesome.com/e3ae686fee.js" crossorigin="anonymous"></script>
  <!-- Style.css -->
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\backend\css\style.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\backend\css\jquery.mCustomScrollbar.css">
</head>